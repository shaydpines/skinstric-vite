...
export default function Nav({ text }) {
    return (
        <div className="bg-white fixed top-0 left-0 flex flex-row h-[64px] w-full justify-between py-3 mb-3 z-[1000]">
            <div className="flex flex-row pt-1 scale-75 justify-center items-center"><Link
                ...
                <p className="text-[#1a1b1c83] text-sm font-semibold leading-[16px] px-1">{text}</p>
