...
export default function Select() {
    ...
    return (
        <>
            ...
            <div className="scale-65 xs:scale-75 sm:scale-100 relative w-svw h-svh sm:overflow-hidden">
                ...
                <div
                    ...
                    {buttons.map((btn, i) => (
                        ...
                        ${i % 2 === 0 ? "mr-[2px]" : "ml-[2px]"}
                        ${i < 2 ? "mb-[2px]" : "mt-[2px]"}
                        ${hovered === i && i < 1 ? "cursor-pointer" : "cursor-not-allowed"}
                        ${
                                hovered === i
            ...
            <Link to={`/start-analysis`} className={`fixed bottom-15 left-9 scale-125`}>
                <ActionButton id={`Back`} label={`Back`} direction={"left"}/>
            </Link>
            <Link to={`/summary`} state={{data: data.current}} className={`fixed bottom-15 right-9 scale-125`}>
