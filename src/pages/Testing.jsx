    ...
    <>
      ...
      <div className="scale-65 xs:scale-75 sm:scale-100 relative w-svw h-svh sm:overflow-hidden">
        ...
        {loading ? (
          ...
          <>
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-4 z-10">
              <p className="text-4xl font-normal text-[#1A1B1C] tracking-wide">
                Thank you!
              </p>
              <p className="text-lg text-[#82878b]">
